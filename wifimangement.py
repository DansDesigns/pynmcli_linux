# Updated:
# def scan() to return ONLY SSID
# added def status() to return CONNECTED or DISCONNECTED status
#
...
def status():
    os.system("nmcli - t - f STATE dev status")
...
def scan():
    os.system("nmcli -t -f SSID dev wifi")
